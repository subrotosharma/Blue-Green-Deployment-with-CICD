pipeline {
    ...
    stages {
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'DevOpsSubroto-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://81FCCFF8CC503720674DA17A8DC2C95F.gr7.us-east-1.eks.amazonaws.com') {
