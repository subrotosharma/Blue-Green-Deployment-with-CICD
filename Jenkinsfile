    ...
    stages {
        ...
        stage('Build JAR') {
            steps {
                ...
                sh 'ls -l target' // DEBUG: ensure .jar exists
            }
        }
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(
                        caCertificate: '',
                        clusterName: 'DevOpsSubroto-cluster',
                        contextName: '',
                        credentialsId: 'k8-token',
                        namespace: KUBE_NAMESPACE,
                        restrictKubeConfigAccess: false,
                        serverUrl: 'https://81FCCFF8CC503720674DA17A8DC2C95F.gr7.us-east-1.eks.amazonaws.com'
                    ) {
